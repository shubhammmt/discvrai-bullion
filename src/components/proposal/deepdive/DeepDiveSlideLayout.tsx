...
export const DeepDiveSlideLayout: React.FC<DeepDiveSlideLayoutProps> = ({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          {sectionLabel && (
            <>
              ...
              <span className={`text-[10px] font-semibold uppercase tracking-widest px-2.5 py-0.5 rounded-full text-white ${sectionColor}`}>
                {sectionLabel}
              </span>
            </>
          )}
      ...
      {/* Footer */}
      <div className="absolute bottom-0 left-0 right-0 px-10 pb-2 flex justify-between items-center text-[10px] text-slate-400">
