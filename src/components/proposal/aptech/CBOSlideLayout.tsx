...
export const CBOSlideLayout: React.FC<CBOSlideLayoutProps> = ({
  children,
  slideNumber,
  totalSlides,
  appendix = false,
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col relative overflow-hidden font-sans">
      ...
      {/* Aptech + DiscvrAI co-brand */}
      <div className="absolute top-4 right-6 z-20 flex items-center gap-3">
        {appendix && (
          <span className="text-xs font-semibold uppercase tracking-widest text-slate-400 border border-slate-200 rounded px-2 py-0.5">
            Appendix
          </span>
        )}
