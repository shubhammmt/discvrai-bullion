...
import AluminaDashboard from './pages/AluminaDashboard';
               ...
               <Route path="/dashboard/bajaj-electricals" element={<BajajElectricalsDashboard />} />
                ...
                <Route path="/DSR" element={<DSRPage />} />
                 ...
                 <Route path="/pitch/diageo-india" element={<DiageoIndiaDeck />} />
                  ...
                  <Route path="/alumina-cop" element={<AluminaDashboard />} />
                  <Route path="/dashboards/alumina-cop" element={<AluminaDashboard />} />
                  <Route path="/alumina-cop/intelligence" element={<AluminaCopDashboard />} />
