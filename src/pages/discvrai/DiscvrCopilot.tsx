...
export default function DiscvrCopilot() {
  return (
    <div className="min-h-screen bg-[#07090d] text-slate-100 antialiased selection:bg-emerald-400/30">
      {/* Ambient glow */}
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-[640px] w-[1100px] -translate-x-1/2 rounded-full bg-emerald-500/10 blur-3xl" />
        <div className="absolute top-[55vh] right-[-10%] h-[420px] w-[640px] rounded-full bg-sky-500/10 blur-3xl" />
        <div className="absolute top-[140vh] left-[-10%] h-[420px] w-[640px] rounded-full bg-violet-500/10 blur-3xl" />
      </div>
...
function TopNav() {
  return (
    <header className="sticky top-0 z-40 border-b border-white/5 bg-[#07090d]/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="/discvrai/copilot" className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <div className="text-[15px] font-semibold tracking-tight text-white">DiscvrAI</div>
            <div className="text-[10px] font-medium uppercase tracking-[0.18em] text-slate-400">Wealth Copilot</div>
          </div>
        </a>
