    ...
    <div className="ai-surface min-h-dvh flex flex-col relative">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        >
          {/* Welcome Section */}
          {showWelcome && (
            <div className="flex-1 flex items-center justify-center px-4 lg:px-8 py-4 min-h-[calc(100vh-12rem)]">
        ...
        {/* Fixed Input Field */}
        <div className="absolute bottom-0 left-0 right-0 pt-1 lg:pt-2 px-3 lg:px-4 pb-3 lg:pb-4 bg-gradient-to-t from-background via-background/90 to-transparent pointer-events-none">
