...
const BASE_URL = import.meta.env.VITE_DISCVR_API_BASE_URL || '';
const BEARER_TOKEN = import.meta.env.VITE_DISCVR_API_TOKEN || '';
const SESSION_ID = import.meta.env.VITE_DISCVR_SESSION_ID || '';
