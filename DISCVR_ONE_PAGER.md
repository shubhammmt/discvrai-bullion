# DISCVR.AI
**Building India's biggest financial distribution platform** | [discvr.ai](https://discvr.ai)
...
**Shubham Srivastava, Founder & CEO**  
2nd-time founder with 20+ years scaling digital platforms. Ex-CTO Hindustan Times Digital (10M→100M+ MAU), Ex-CTO Eureka Forbes (1M+ MAU), Ex-MakeMyTrip (Hotels LOB). Founded Tekch (PropTech SaaS). B.Tech, IIT(ISM) Dhanbad.  
[LinkedIn](https://www.linkedin.com/in/shubhamsrivastava1/)

**Smriti Srivastava, Co-Founder**  
Equal equity partner, contributing to strategic direction and operations.

**Advisory Team:**
- **Sharat Singh** – Tech Advisor (Ex-CTO MakeMyTrip, Ex-CTO Nexttag)
- **Anil Singh** – Content & SEO Lead (Ex-TOI, Ex-HT, part-time employed)
- **Inderpreet Singh** – Growth & Marketing Advisor (Ex-TataSky, Business Head OTTPlay)
- **Ramji Tripathi** – Product Advisor (Ex-TOI, Ex-HT, Ex-Airtel, VP Reliance)
- **Abhishek Singh** – Finance & Compliance (Enabled Indmoney 0-1, part-time employed)
...
- 2% commission on Digital Gold purchases
- 2% commission on Digital Silver purchases
- 1.5% commission on Personal Loan disbursals
...
- **Digital Gold:** 3M UPI-native savers aged 23-35 in Tier-1/2 cities (Market: ₹14,000 cr → ₹49,280 cr)
- **Digital Silver:** 1M value-conscious early adopters seeking inflation hedge (Market: ₹2,400 cr → ₹10,659 cr)
- **Personal Loans:** 1M users seeking sub-₹25K loans (Market: ₹1,00,000 cr → ₹2,77,308 cr)

**Current Traction:**  
11K → 25K → 100K monthly sessions (Sep-Nov 2024), 3+ min session duration, 10% organic reach

---

## Competitors

**Groww & Jar:** New-age fintech with strong brand recall through paid acquisition and subsidized growth. DISCVR.AI differentiates through content-led, habit-forming flywheel vs. high-CAC paid funnels.

**PhonePe & HDFC:** Established financial services players relying on recall and one-size-fits-all product offerings. DISCVR.AI offers AI-personalized discovery based on behavioral signals (watchlists, dwell time, tool usage).

**Zepto & Blinkit:** Quick-commerce platforms expanding into financial products through paid acquisition. DISCVR.AI leverages organic content-to-commerce graph with zero-CAC distribution.

**Key Moats:**
- 14K+ AI-personalized research pages with behavioral data layer
- Content-to-commerce flywheel (180-500 articles/day creating permanent growth assets)
- Habit stack (quizzes, polls, watchlists, alerts, WhatsApp/Telegram communities)
- Focused beachheads in under-penetrated categories (LAMF, digital precious metals)

---

## Funding Round Details

**Looking to raise ₹4.2 crore Pre-Seed** for the following activities:

**Use of Funds:**
- **Tech + Product (27.60%):** ₹1.159 crore – Strengthen discovery-led growth infrastructure
...
**Contact:**  
Shubham Srivastava  
shubham@discvr.ai | +91 98739 61591  
[LinkedIn](https://www.linkedin.com/in/shubhamsrivastava1/)
